...
C41 accepted-repaired (0 rejected, 0 waived); round 21 re-audits the new blob SHA. **Amendment CFADA verdict: PENDING round-21 re-review** (this section is the round record, not a PASS).
