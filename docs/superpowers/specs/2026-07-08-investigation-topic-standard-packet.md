...
All three accepted-repaired (0 rejected, 0 waived). Repairs land in the next commit; round 18 re-audits the new blob SHA. **Amendment CFADA verdict: PENDING round-18 re-review** (this section is the round record, not a PASS).
