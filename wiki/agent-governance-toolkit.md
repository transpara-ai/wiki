...
raw_documents:
  - "raw/civilization/external-landscape/tai-res-2026-009-agent-governance-toolkit-evaluation.md"  # sha256 a6c6c9a263cfd5d21cf60cba881b685fd478fc6f91e7ca5d560c264463faa800; TAI-RES-2026-009 v1.0.1; session-authored Civilization external-landscape research, placed outside the browser-ingest inbox by design — provenance is git history + this frontmatter
---
...
> - **A suite, not a layer — Microsoft-owned, Public Preview.** 15+ packages (real core = `agent-os` + `agent-mesh`) carrying competing trust/reward, audit-ledger, and signed-identity planes; `Copyright (c) Microsoft Corporation` on most source files; "Public Preview / Beta." "13,000+ tests" holds as a magnitude (**12,617** Python `def test_`).
...
**Reference / context:**
- `raw/civilization/external-landscape/tai-res-2026-009-agent-governance-toolkit-evaluation.md` — **TAI-RES-2026-009 v1.0.1**, the code-anchored evaluation (sha256 `a6c6c9a263…`); this page is its digest and carries the full `file:line` anchors, the doctrine map, and the §4.4 determination.
