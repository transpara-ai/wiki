...
*(The auto-derived article-count block lives on the front page, where `compile/refresh.py` keeps it current; at the time this narrative was archived it read: 101 articles.)*
