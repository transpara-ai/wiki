...
> **Renamed from `DESIGN.md` on 2026-07-10.** Historical documents (review archives, dated specs) that cite `DESIGN.md` mean this file. Root `DESIGN.md` now holds the visual design system.
